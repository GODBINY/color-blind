...
const questions = {
  ko: [
    ...
    ["‘적록색약’은 하나의 유형인가요?", "보통 Protan과 Deutan을 함께 부르는 말이에요. 실제 경험과 차이의 정도는 한 사람마다 다를 수 있어요."],
    ...
    ["Iris는 사진을 어디에 저장하나요?", "Iris의 사진 작업은 이 기기 안에서 이뤄지도록 설계되어 있어요. 사진을 서버에 올리지 않아요."],
  ...
  en: [
    ...
    ["Where does Iris keep my photos?", "Iris is designed to process photos on this device. Your photo is not uploaded to a server."],
